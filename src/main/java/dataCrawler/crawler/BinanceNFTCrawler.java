...
public class BinanceNFTCrawler extends Crawler<Collection> {
    private static final String URL = "https://www.binance.com/en/nft/ranking?tab=trend&chain=ALL";
    private static final String JSON_PATH = "data/BinanceNFT.json";

    public BinanceNFTCrawler(String json_file_path, String... page_urls) {
        super(json_file_path, page_urls);
    }

    public static void main(String[] args) throws IOException {
        BinanceNFTCrawler binanceNFTCrawler = new BinanceNFTCrawler(JSON_PATH, URL);
    ...
    public void crawlData() {
        for (String PAGE_URL : PAGE_URLs) {
            ...
            wait.until(ExpectedConditions.presenceOfElementLocated(By.className("css-1xxn6ao")));

            List<WebElement> webElements = driver.findElements(By.className("css-1xxn6ao"));
